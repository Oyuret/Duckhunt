...
class GameServer
{
	...
	public GameServer(BufferedReader pInputStream, PrintStream pOutputStream)
	{
		mMaxRounds = 2;
		mMaxTurns = 100;
		mTimeForShoot = 200000;
		mTimeForHit = 2000000;
		mTimeForGuess = 100000000;
		mTimeForReveal = 10000000;
	...
	public void run()
	{
		...
		{
			if (Main.gVerbose)
				System.err.println("Loading default game");
			load(new StringReader(Constants.DEFAULT_GAME_SEASON));
		}
